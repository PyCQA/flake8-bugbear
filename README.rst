...
**B908**: Contexts with exceptions assertions like ``with self.assertRaises`` or ``with pytest.raises`` should have not multiple top-level statements. Each statement should be in its own context.
